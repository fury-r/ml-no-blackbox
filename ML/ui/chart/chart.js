class Chart {
  ...
  #draw() {
    ...
    if (this.dynamicPoint) {
      const pixeLoc = math.remapPoint(
        this.dataBounds,
        this.pixelBounds,
        this.dynamicPoint
      );
      graphics.drawPoint(ctx, pixeLoc, "rgb(255,255,255,0.7)", 10000000);
      // ctx.strokeStyle = "gray";
      // this.nearestSamples.map((nearestSample) => {
      //   graphics.drawPointTo(
      //     ctx,
      //     pixeLoc,
      //     math.remapPoint(
      //       this.dataBounds,
      ...
      this.label
        ? graphics.drawImage(ctx, this.styles[this.label].image, pixeLoc)
        : graphics.drawPoint(ctx, pixeLoc, "black");
    }
  ...
  showDynamicPoint(point, label, nearetSamples) {
    this.dynamicPoint = point;
    this.label = label;
    this.nearestSamples = nearetSamples;
    this.#draw();
  }
